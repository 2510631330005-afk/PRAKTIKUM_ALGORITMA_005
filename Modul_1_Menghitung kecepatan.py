...
kereta_cepat = hitung_kecepatan(5000, 300)
pemain_sepak_bola = hitung_kecepatan(60, 7)
print (f"Drone {drone:.2f} m/s")
print (f"Kereta Cepat {kereta_cepat:.2f} m/s")
print (f"Pemain Sepak Bola {pemain_sepak_bola:.2f} m/s")
if drone > kereta_cepat and drone > pemain_sepak_bola:
    print("Drone tercepat")
elif kereta_cepat > drone and kereta_cepat > pemain_sepak_bola:
    print("Kereta Cepat tercepat")
else: 
